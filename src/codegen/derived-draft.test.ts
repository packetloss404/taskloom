...
test("derives appName from package.json", () => {
  const files: GeneratedFile[] = [
    { path: "package.json", contents: JSON.stringify({ name: "billing-portal" }) },
...
test("derives multiple pages when src/pages/* is present", () => {
  const files: GeneratedFile[] = [
    { path: "package.json", contents: JSON.stringify({ name: "site" }) },
    { path: "src/App.tsx", contents: APP_TSX },
    { path: "src/pages/index.tsx", contents: "export default function Home() { return null; }" },
    { path: "src/pages/about.tsx", contents: "export default function About() { return null; }" },
    { path: "src/pages/users/[id].tsx", contents: "export default function User() { return null; }" },
  ];
...
test("derives api route stubs from src/api/*", () => {
  const files: GeneratedFile[] = [
    { path: "package.json", contents: JSON.stringify({ name: "api-app" }) },
    { path: "src/App.tsx", contents: APP_TSX },
    { path: "src/api/users.ts", contents: "export function POST() {}" },
  ];
...
test("derives data schema entities from src/data/*", () => {
  const files: GeneratedFile[] = [
    { path: "package.json", contents: JSON.stringify({ name: "schemaful" }) },
    { path: "src/App.tsx", contents: APP_TSX },
    { path: "src/data/customer.ts", contents: "export type Customer = { id: string };" },
    { path: "src/data/order.ts", contents: "export type Order = { id: string };" },
  ];
...
test("falls back to App component name when package.json has no name", () => {
  const files: GeneratedFile[] = [
    { path: "package.json", contents: JSON.stringify({}) },
    { path: "src/App.tsx", contents: "export default function FleetTracker() { return null; }" },
  ];
