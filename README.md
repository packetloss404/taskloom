...
- Phase 53 multi-writer topology requirements/design gate plus Phase 54 owned design-package gate that keep horizontal writers, regional failover, PITR, and active-active needs blocked until an owner, consistency model, failover/PITR plan, migration/backfill plan, observability requirements, and rollback strategy are documented
