...
- [ ] Continue the relational-repository migration started in Phases 32-33 (`jobMetricSnapshots`, `alertEvents`) through queued collections: `agentRuns`, `jobs`, `invitationEmailDeliveries`, `activities`, then drop the legacy JSON-side mirrors. See `docs/roadmap-relational-repositories.md`.
