...
- [ ] Continue the relational-repository migration started in Phase 32 (`jobMetricSnapshots`) through queued collections: `alertEvents`, `agentRuns`, `jobs`, `invitationEmailDeliveries`, `activities`, then drop the legacy JSON-side mirrors. See `docs/roadmap-relational-repositories.md`.
