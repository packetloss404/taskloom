...
- [ ] Continue the relational-repository migration started in Phases 32-34 (`jobMetricSnapshots`, `alertEvents`, `agentRuns`) through queued collections: `jobs`, `invitationEmailDeliveries`, `activities`, then drop the legacy JSON-side mirrors. See `docs/roadmap-relational-repositories.md`.
