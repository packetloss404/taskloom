...
6. Treat Phase 54 as the owned design-package gate before implementation.
7. Keep unsupported managed database hints, missing adapter/URL pairs, multi-writer/distributed topology, regional failover, PITR, and active-active writes blocked until a real topology package documents the owner, consistency model, failover/PITR plan, migration/backfill plan, observability requirements, and rollback strategy.
