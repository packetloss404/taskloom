...
- Phase 53/54/55 multi-writer topology gate context, including whether horizontal database writers, regional failover, PITR, or active-active writes are being claimed before a topology is designed, owned, captured in a design package, reviewed, and authorized for implementation.
