...
- Phase 53/54/55/56 multi-writer topology gate context, including whether horizontal database writers, regional failover, PITR, or active-active writes are being claimed before a topology is designed, owned, captured in a design package, reviewed, authorized for implementation, proven ready to implement, and covered by rollout-safety evidence.
