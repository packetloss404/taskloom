...
- Phase 53/54 multi-writer topology gate context, including whether horizontal database writers, regional failover, PITR, or active-active writes are being claimed before a topology is designed, owned, and captured in a design package.
