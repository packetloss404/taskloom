...
- Phase 48 runtime-boundary context: managed/Postgres store modes and managed database URL hints fail closed in the current synchronous store path until an async managed database adapter exists.
